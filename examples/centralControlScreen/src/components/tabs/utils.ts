...
const { RatioUtils, NumberUtils } = Utils;
const { winWidth } = RatioUtils;
const { inMaxMin } = NumberUtils;
 ...
 */
export const getTabWidth = (maxNum = 4, tabsWidth = winWidth) => tabsWidth / maxNum;
 ...
 */
export const getIndexByDeltaX = (deltaX, indexWidth) => Math.floor(deltaX / indexWidth);
 ...
 */
export const getNearestIndexByDeltaX = (deltaX, indexWidth, maxIndex = 100) => {
 ...
 */
export const getSiblingIndex = (index, min, max) => {
 ...
 */
export const getCenteredScrollIndex = (idx, oneScreenTabNum, totalNum) => {
  const min = 0;
 ...
 */
export const isValidPress = (dx, dy) =>
 ...
 */
export const isValidSwipe = (velocity, direction) => {

...
import { Utils } from "tuya-panel-lit";
...
export const timer = {
  ...
  titleFontColor: props =>
    getTheme(props, "timer.titleFontColor", d1.titleFontColor),
  ...
  thumbTintColor: props =>
    getTheme(props, "timer.thumbTintColor", d1.thumbTintColor),
  onThumbTintColor: props =>
    getTheme(props, "timer.onThumbTintColor", d1.onThumbTintColor),
  ...
  statusBgStyle: props =>
    getTheme(props, "timer.statusBgStyle", d1.statusBgStyle)
};

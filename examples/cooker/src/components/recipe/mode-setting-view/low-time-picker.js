...
export default class MinCountdownView extends Component {
  static propTypes = {
    name: PropTypes.string.isRequired,
    value: PropTypes.number, // 单位: 秒
    onValueChange: PropTypes.func.isRequired, // 返回单位: 秒
    min: PropTypes.number, // 单位: 秒
    max: PropTypes.number, // 单位: 秒
    step: PropTypes.number, // 单位: 秒
    onlyone: PropTypes.bool, // 秒
  ...
  handleComplete() {
    if (this.props.onValueChange) {
      ...
      this.props.onValueChange(value >= this.props.max ? this.props.max : value);
    }
  }
  handleCancel = () => {
        ...
        >
          ...
          <TYText
            style={[
              styles.label,
              {
                marginLeft: -(window.width * (4 / 10 / 2.5)) + (isIOS ? 15 : 0),
              },
            ]}
            pointerEvents="none"
